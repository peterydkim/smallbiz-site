...
export const metadata: Metadata = {
  ...
  description:
    "General contractor serving Maryland, Virginia and Washington DC since 2006. Kitchen, bathroom and basement remodeling, roofing, decks, water damage restoration. Free estimates within 24 hours.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "General contractor serving Maryland, Virginia and DC since 2006. Free estimates within 24 hours.",
  ...
  twitter: {
    ...
    title: "A+ Construction Services — Built for how you live.",
    description:
      "General contractor serving Maryland, Virginia and DC since 2006.",
    images: ["/images/kitchen-quartz-island.jpg"],
  },
